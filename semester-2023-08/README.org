...
- Nov 29: Doris: Pesenting my research topic for expanding the open source ecosystem around data.table in R. Over the next two years, I will be focusing on enhancing the functionalities, improving documentation,etc. Find the slides to this presentation [[https://github.com/DorisAmoakohene/Data.table-Prentation][here]]
- Dec 6: Trevor
